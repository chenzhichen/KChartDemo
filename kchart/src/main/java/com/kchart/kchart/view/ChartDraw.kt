...
abstract class ChartDraw {
     ...
     * 绘制边框
     */
    abstract fun drawGrid(view: KChartView, canvas: Canvas, rect: RectF)

    /**
     * 绘制Y轴坐标
     */
    abstract fun drawYValue(view: KChartView, canvas: Canvas, rect: RectF)

    /**
     * 绘制指标数据
     */
    abstract fun drawIndexText(view: KChartView, canvas: Canvas, rect: RectF, e: LongPressEvent?)

    /**
     * 绘制长按十字线
     */
    abstract fun drawLongPressLine(
        view: KChartView,
        canvas: Canvas,
        rect: RectF,
        e: LongPressEvent?
